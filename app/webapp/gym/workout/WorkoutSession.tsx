...
export default function WorkoutSession({
    ...
    const loadWorkout = async () => {
      if (workoutId) {
        ...
        if (result.success && result.data) {
          ...
          setIsPastWorkout(!isToday(new Date(result.data.createdAt)));
        } else {
          setWorkout(null);
        }
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {!isPastWorkout && (
          <button
            ...
            className="w-full bg-background-600 hover:bg-background-500 border-2 border-dashed border-background-400 rounded-lg p-8 transition-colors flex flex-col items-center gap-2 text-text-low hover:text-text-high"
          >
      ...
      {/* Notes */}
      <div className="bg-background-600 rounded-lg p-6 border border-background-500">
        <h3 className="text-lg font-semibold text-text-high mb-3">
          Workout Notes
        </h3>
        <textarea
          value={notes}
      ...
      <div className="flex gap-4">
        ...
        >
          ...
          {isPastWorkout ? "Save Name" : "Save Progress"}
        </button>
        {isPastWorkout ? (
          <button
            onClick={() => router.back()}
