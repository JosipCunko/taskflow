...
export default function TaskCardSmall({ task }: { task: Task }) {
  ...
  return (
    <li className="group relative list-none cursor-default">
      ...
      <div className="relative bg-gradient-to-br from-background-700/80 via-background-650/80 to-background-600/80 backdrop-blur-sm rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-primary-500/20 border border-transparent">
        <div className="flex items-start justify-between mb-3">
          {/* Task Icon */}
          <div
            className="p-2.5 rounded-lg shadow-md border border-background-500/30 backdrop-blur-sm"
            style={{
        ...
        <div className="mb-2">
          <h4 className="text-md font-bold text-text-high leading-tight line-clamp-2">
            {task.title}
          </h4>
        </div>
